...
#include <sts/common/print_helpers.hpp>
#include <sts/sim/agents/random_agent.hpp>
#include <sts/sim/agents/scum_search_agent2.hpp>
#include <sts/sim/agents/simple_agent.hpp>
